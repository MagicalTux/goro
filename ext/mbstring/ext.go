...
func init() {
	phpctx.RegisterExt(&phpctx.Ext{
		...
		Functions: map[string]*phpctx.ExtFunction{
			...
			"mb_convert_variables":    {Func: fncMbConvertVariables, MinArgs: 3, MaxArgs: -1, Args: []*phpctx.ExtFunctionArg{
				{ArgName: "to_encoding"},
				{ArgName: "from_encoding"},
				{ArgName: "var", Ref: true},
			}},
			...
			"mb_encode_numericentity":  {Func: fncMbEncodeNumericentity, Args: []*phpctx.ExtFunctionArg{}},
			"mb_decode_numericentity":  {Func: fncMbDecodeNumericentity, Args: []*phpctx.ExtFunctionArg{}},
			"mb_decode_mimeheader":     {Func: fncMbDecodeMimeheader, Args: []*phpctx.ExtFunctionArg{}},
			"mb_encode_mimeheader":     {Func: fncMbEncodeMimeheader, Args: []*phpctx.ExtFunctionArg{}},
			"mb_convert_kana":          {Func: fncMbConvertKana, Args: []*phpctx.ExtFunctionArg{}},
			"mb_regex_set_options":     {Func: fncMbRegexSetOptions, Args: []*phpctx.ExtFunctionArg{}},
			"mb_ucfirst":               {Func: fncMbUcfirst, Args: []*phpctx.ExtFunctionArg{}},
			"mb_lcfirst":               {Func: fncMbLcfirst, Args: []*phpctx.ExtFunctionArg{}},
		},
		Constants: map[phpv.ZString]phpv.Val{
			"MB_CASE_UPPER":           phpv.ZInt(0),
			"MB_CASE_LOWER":           phpv.ZInt(1),
			"MB_CASE_TITLE":           phpv.ZInt(2),
			"MB_CASE_FOLD":            phpv.ZInt(3),
			"MB_CASE_UPPER_SIMPLE":    phpv.ZInt(4),
			"MB_CASE_LOWER_SIMPLE":    phpv.ZInt(5),
			"MB_CASE_TITLE_SIMPLE":    phpv.ZInt(6),
			"MB_CASE_FOLD_SIMPLE":     phpv.ZInt(7),
