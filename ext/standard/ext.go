...
func init() {
	phpctx.RegisterExt(&phpctx.Ext{
		...
		Functions: map[string]*phpctx.ExtFunction{
			...
			"array_multisort":            {Func: fncArrayMultiSort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", Ref: true}}},
			...
			"extract":                    {Func: fncArrayExtract, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", Ref: true}, {ArgName: "flags", Optional: true}, {ArgName: "prefix", Optional: true}}},
