...
func init() {
	phpctx.RegisterExt(&phpctx.Ext{
		...
		Functions: map[string]*phpctx.ExtFunction{
			...
			"array_pop":                  {Func: fncArrayPop, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}}},
			"array_product":              {Func: fncArrayProduct, Args: []*phpctx.ExtFunctionArg{}},
			"array_push":                 {Func: fncArrayPush, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}}},
			...
			"array_shift":                {Func: fncArrayShift, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}}},
			"array_slice":                {Func: fncArraySlice, Args: []*phpctx.ExtFunctionArg{}},
			"array_splice":               {Func: fncArraySplice, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "offset"}, {ArgName: "length", Optional: true}, {ArgName: "replacement", Optional: true}}},
			...
			"array_unshift":              {Func: fncArrayUnshift, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}}},
			"array_values":               {Func: fncArrayValues, Args: []*phpctx.ExtFunctionArg{}},
			"array_walk":                 {Func: fncArrayWalk, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "callback"}, {ArgName: "arg", Optional: true}}},
			"array_walk_recursive":       {Func: fncArrayWalkRecursive, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "callback"}, {ArgName: "arg", Optional: true}}},
			"arsort":                     {Func: fncArrayARSort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "flags", Optional: true}}},
			"asin":                       {Func: mathAsin, Args: []*phpctx.ExtFunctionArg{}},
			"asinh":                      {Func: mathAsinh, Args: []*phpctx.ExtFunctionArg{}},
			"asort":                      {Func: fncArrayASort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "flags", Optional: true}}},
			...
			"file_get_contents":          {Func: fncFileGetContents, Args: []*phpctx.ExtFunctionArg{{ArgName: "filename"}, {ArgName: "use_include_path", Optional: true}, {ArgName: "context", Optional: true}, {ArgName: "offset", Optional: true}, {ArgName: "length", Optional: true}}},
			"file_put_contents":          {Func: fncFilePutContents, Args: []*phpctx.ExtFunctionArg{{ArgName: "filename"}, {ArgName: "data"}, {ArgName: "flags", Optional: true}, {ArgName: "context", Optional: true}}},
			...
			"getimagesize":               {Func: fncGetImageSize, Args: []*phpctx.ExtFunctionArg{{ArgName: "filename"}, {ArgName: "image_info", Ref: true, Optional: true}}},
			"getimagesizefromstring":     {Func: fncGetImageSizeFromString, Args: []*phpctx.ExtFunctionArg{{ArgName: "string"}, {ArgName: "image_info", Ref: true, Optional: true}}},
			...
			"image_type_to_extension":    {Func: fncImageTypeToExtension, Args: []*phpctx.ExtFunctionArg{{ArgName: "image_type"}, {ArgName: "include_dot", Optional: true}}},
			"image_type_to_mime_type":    {Func: fncImageTypeToMimeType, Args: []*phpctx.ExtFunctionArg{{ArgName: "image_type"}}},
			...
			"krsort":                     {Func: fncArrayKRSort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "flags", Optional: true}}},
			"ksort":                      {Func: fncArrayKSort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "flags", Optional: true}}},
			...
			"rsort":                      {Func: fncArrayRSort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "flags", Optional: true}}},
			...
			"shuffle":                    {Func: fncArrayShuffle, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}}},
			...
			"sort":                       {Func: fncArraySort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "flags", Optional: true}}},
			...
			"stream_bucket_append":         {Func: fncStreamBucketAppend, Args: []*phpctx.ExtFunctionArg{}},
			"stream_bucket_prepend":        {Func: fncStreamBucketPrepend, Args: []*phpctx.ExtFunctionArg{}},
			"stream_bucket_make_writeable": {Func: fncStreamBucketMakeWriteable, Args: []*phpctx.ExtFunctionArg{}},
			...
			"uasort":                     {Func: fncArrayUASort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "callback"}}},
			"ucfirst":                    {Func: fncUcFirst, Args: []*phpctx.ExtFunctionArg{}},
			"ucwords":                    {Func: fncUcWords, Args: []*phpctx.ExtFunctionArg{}},
			"uksort":                     {Func: fncArrayUKSort, Args: []*phpctx.ExtFunctionArg{{ArgName: "array", NoticeRef: true}, {ArgName: "callback"}}},
			...
			"stream_socket_pair":         {Func: fncStreamSocketPair, Args: []*phpctx.ExtFunctionArg{}},
			"stream_socket_shutdown":     {Func: fncStreamSocketShutdown, Args: []*phpctx.ExtFunctionArg{}},
			"stream_socket_get_name":     {Func: fncStreamSocketGetName, Args: []*phpctx.ExtFunctionArg{}},
		...
		Constants: map[phpv.ZString]phpv.Val{
			...
			"STREAM_PF_UNIX": STREAM_PF_UNIX, "STREAM_PF_INET": STREAM_PF_INET, "STREAM_PF_INET6": STREAM_PF_INET6,
			"STREAM_SOCK_STREAM": STREAM_SOCK_STREAM, "STREAM_SOCK_DGRAM": STREAM_SOCK_DGRAM,
			"STREAM_SOCK_RAW": STREAM_SOCK_RAW, "STREAM_SOCK_SEQPACKET": STREAM_SOCK_SEQPACKET,
			"STREAM_SOCK_RDM": STREAM_SOCK_RDM,
			"STREAM_IPPROTO_IP": STREAM_IPPROTO_IP, "STREAM_IPPROTO_TCP": STREAM_IPPROTO_TCP,
			"STREAM_IPPROTO_UDP": STREAM_IPPROTO_UDP, "STREAM_IPPROTO_ICMP": STREAM_IPPROTO_ICMP,
			"STREAM_IPPROTO_RAW": STREAM_IPPROTO_RAW,
			"PSFS_PASS_ON": PSFS_PASS_ON, "PSFS_FEED_ME": PSFS_FEED_ME, "PSFS_ERR_FATAL": PSFS_ERR_FATAL,
		},
	})
}
