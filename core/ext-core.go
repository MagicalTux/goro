...
func init() {
	phpctx.RegisterExt(&phpctx.Ext{
		...
		Constants: map[phpv.ZString]phpv.Val{
			...
			"PHP_OUTPUT_HANDLER_CLEAN":     phpv.ZInt(phpctx.BufferClean),
			"PHP_OUTPUT_HANDLER_CLEANABLE": phpv.ZInt(phpctx.BufferCleanable),
			"PHP_OUTPUT_HANDLER_CONT":      phpv.ZInt(phpctx.BufferWrite),
			"PHP_OUTPUT_HANDLER_END":       phpv.ZInt(phpctx.BufferFinal),
			"PHP_OUTPUT_HANDLER_FINAL":     phpv.ZInt(phpctx.BufferFinal),
			"PHP_OUTPUT_HANDLER_FLUSH":     phpv.ZInt(phpctx.BufferFlush),
			"PHP_OUTPUT_HANDLER_FLUSHABLE": phpv.ZInt(phpctx.BufferFlushable),
			"PHP_OUTPUT_HANDLER_REMOVABLE": phpv.ZInt(phpctx.BufferRemovable),
			"PHP_OUTPUT_HANDLER_START":     phpv.ZInt(phpctx.BufferStart),
			"PHP_OUTPUT_HANDLER_STDFLAGS":  phpv.ZInt(phpctx.BufferCleanable | phpctx.BufferFlushable | phpctx.BufferRemovable),
			"PHP_OUTPUT_HANDLER_WRITE":     phpv.ZInt(phpctx.BufferWrite),
