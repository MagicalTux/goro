...
...with precision 3-> float(123456789)
...with precision 21-> float(123456789)
...
...with precision 3-> float(123.457)
...with precision 21-> float(123.456789)
...
...with precision 3-> float(-4.568)
...with precision 21-> float(-4.5679123)
...
...with precision 3-> float(2311527)
...with precision 21-> float(2311527)
...
...with precision 3-> float(14680063)
...with precision 21-> float(14680063)
...
...with precision 3-> float(1.235)
...with precision 21-> float(1.234567)
...
...with precision 3-> float(234567890)
...with precision 21-> float(234567890)
