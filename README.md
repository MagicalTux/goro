...
Goro passes **6,012 of 12,110 tests** (49.6%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,562/2,000 (80.3%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
