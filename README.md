...
Goro passes **~6,300+ of 12,110 tests** (~52%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,567/2,000 (80.5%)**. PHP-style memory_limit enforcement (128MB default).
