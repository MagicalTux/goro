...
Goro passes **~11,827 of 12,110 tests** (~97.6%) from the PHP 8.5.4 test suite (197 failures, 86 skipped in CI). PHP memory_limit enforcement (128MB default). Includes PCRE2 via gopcre2, IANA timezones via gotz, and 9 extensions (session, xml, curl, sockets, zlib, mysqli, sqlite3, bz2).
