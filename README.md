...
Goro passes **6,320 of 12,110 tests** (52.2%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,656/2,000 (85.1%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
