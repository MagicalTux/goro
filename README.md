...
Goro passes **6,100+ of 12,110 tests** (~50%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,561/2,000 (80.2%)**. All batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
