...
Goro passes **6,430 of 12,110 tests** (53.1%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,664/2,000 (85.6%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
