...
Goro passes **6,600 of 12,110 tests** (54.5%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,671/2,000 (85.9%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
