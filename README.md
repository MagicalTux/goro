...
Goro passes **6,834 of 12,110 tests** (56.4%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,692/2,000 (87.0%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
