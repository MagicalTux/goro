...
Goro passes **6,650 of 12,110 tests** (54.9%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,684/2,000 (86.6%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
