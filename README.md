...
Goro passes **7,059 of 12,110 tests** (58.3%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,696/2,000 (87.2%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
