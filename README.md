...
Goro passes **3,270+ tests** from the PHP 8.5.4 test suite (12,110 total). First 2,000 tests: **1,376/2,000 (70.8%)**. OOM bugs fixed: json_encode recursion detection, range() size limits, serialize depth limits.
