...
Goro passes **6,414 of 12,110 tests** (53.0%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,658/2,000 (85.2%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
