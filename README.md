...
Goro passes **6,199 of 12,110 tests** (51.2%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,635/2,000 (84.1%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
