...
Goro passes **6,105 of 12,110 tests** (50.4%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,607/2,000 (82.5%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
