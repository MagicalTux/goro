...
Goro passes **6,240 of 12,110 tests** (51.5%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,636/2,000 (84.1%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
