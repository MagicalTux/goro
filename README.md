...
Goro passes **6,078 of 12,110 tests** (50.2%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,599/2,000 (82.1%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
