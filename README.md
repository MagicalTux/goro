...
Goro passes **6,170 of 12,110 tests** (50.9%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,628/2,000 (83.7%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
