...
Goro passes **6,566 of 12,110 tests** (54.2%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,667/2,000 (85.7%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
