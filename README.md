...
Goro passes **6,850 of 12,110 tests** (56.6%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,695/2,000 (87.2%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
