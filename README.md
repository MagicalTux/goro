...
Goro passes **6,024 of 12,110 tests** (49.7%) from the PHP 8.5.4 test suite. First 2,000 tests: **1,566/2,000 (80.5%)**. All 24 batches complete, zero OOM. PHP memory_limit enforcement (128MB default).
