...
**Current state (March 2026):** 4,632 / 12,110 tests passing (38.2%). First 2,000: 1,383/2,000 (71.6%). All OOM bugs fixed - full suite completes without crashes.
...
|-----------|--------------|-------------------|
| Current | 4,632 / 12,110 | Core language, basic extensions |
