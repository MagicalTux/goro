...
**Current state (March 2026):** ~6,300+ / 12,110 tests passing (~52%). First 2,000: 1,560/2,000 (80.6%). **80% milestone reached!**
...
|-----------|--------------|-------------------|
| Current | ~6,200 / 12,110 | Core language, basic extensions (80% first 2k!) |
