...
**Current state (March 2026):** 3,349+ / 9,110 tested (12,110 total). First 2,000: 1,376/2,000 (70.8%). Some test batches OOM due to engine bugs being fixed.
...
|-----------|--------------|-------------------|
| Current | 3,349+ / 12,110 | Core language, basic extensions |
